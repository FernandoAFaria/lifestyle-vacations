...
const detailedResortInfo = [
  ...
  },
  {
    ...
    data:
      "Set within the sprawling Lifestyle Holidays Vacation Resort, The Tropical offers a classic hotel vacation experience set within quaint, two- and three- story, Mediterranean-style buildings. The mood is laid-back and distinctively Caribbean. Guest enjoy all resort facilities and amenities(excluding the V.I.P areas) including three swimming pools, a choice of excellent restaurants, exercise rooms, tennis courts, windsurfing and so much more. The Lifestyle Tropical is ideal for couples seeking a private island hideaway with all the advantages of a world-class resort.",
...
The gorgeous and luxurious resort has one, two and three bedroom suites available. All buildings have elevators and offer rooms with views of the garden, the pool, or the ocean. All suites are air-conditioned and the living area is set up with designer furniture, fully equipped kitchens with refrigerator, coffee makers, as well as glass and silverware, dining room with table and chairs, and balcony or terrace.  Find out more at http://www.presidentialsuitepuntacana.com/`,
    ...
    occupancy:
      "1-Bedroom (Maximum 4 persons), 2-Bedroom(Maximum 6 persons), 3-Bedroom(Maximum 8 persons)"
  },
  {
...
class Resorts extends React.Component {
  ...
  render() {
    ...
    const renderInfo = () => {
      if (
        this.state.id === "tropical" ||
        this.state.id === "confresi" ||
        this.state.id === "dreamsuites" ||
        this.state.id === "presidential" ||
        this.state.id === "royalsuites" ||
        this.state.id === "crownvillas"
      ) {
        return (
          <section style={inclusivePlan} className="inclusive-plan">
            <div
              style={{ minWidth: "50%", marginRight: "10%", color: "black" }}
            >
              ...
              >
                <li>
                  Privileged use of all restaurants, bars, and facilities at the
                  Resort (V.I.P areas and services exclusive for Members)
                </li>
                <li>
                  24-hour food and beverages available in select locations
                </li>
                <li>
                  All meals – access to breakfast, lunch, and dinner in any of
                  our restaurants on property (some restaurants require advance
                  reservations)
                </li>
                <li>
                  9 All Guest restaurants for a la carte dining (Reservations
                  may be required)
                </li>
                <li>
                ...
                <li>
                  ...
                  including 11 V.I.P Lite Fare Bars
                </li>
                <li>
                  Includes: House Wine with Meals, plus Beer, Spirits,
                  Cocktails, Juices, and Soft Drinks are available from all Bars
      ...
      <div style={{ textAlign: "center", marginTop: "10%" }}>
            ...
            <ul className="flex-outer">
              ...
              <li>
                ...
                <input
                  ...
                  onChange={event => handleCheckinDate(event.target.value)}
                />
              </li>
              <li>
                ...
                <input
                  ...
                  onChange={event => handleCheckoutDate(event.target.value)}
                />
              </li>
              <li>
              ...
              <button
                ...
                className="btn-book"
                type="submit"
                onClick={e => handleSubmitResort(e)}
              >Submit </button>
            </ul>
          </form>
        </div>
        <div style={imageContainer}>
          {this.state.pics.map((x, index) => {
            return (
              <div key={index}>
                <img style={images} src={x} alt="Tropical Suite Pictures" />
              </div>
            );
          })}
          {renderInfo()}
